...
urls = ["https://butterfly-conservation.org/" +
        page for page in butterfly_pages]
...
def process_each_link(urls):
    butterflys = []
    for url in range(10, 20):
        butterflys.append(get_butterfly(urls[url]))
    return butterflys


print(process_each_link(urls))
